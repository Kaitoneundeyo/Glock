    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @forelse ($user as $u) <!-- Menggunakan $u sebagai item dalam $user -->
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modal-hapus{{ $u->id }}" tabindex="-1" aria-labelledby="modalLabel{{ $u->id }}" aria-hidden="true">
